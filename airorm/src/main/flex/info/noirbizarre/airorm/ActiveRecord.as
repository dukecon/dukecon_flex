	...
	public class ActiveRecord extends Proxy implements IEventDispatcher, IUID
	{
		...
		public function get uid():String {
			if (!_id) {
				...
				return className +"_"+ _id.toString();
			}
		}
		 ...
		 */
		public function load(id:String):Boolean
		{
		...
		public function save():Boolean
		{
			...
			if (!_id && hasOwnProperty(schemaTranslation.getCreatedField(this)))
			...
			if (_id) // this is an update statement
			{
			...
			if (!_id)
				_id = String(connection.lastInsertRowID);
		 ...
		 */
		public function find(id:String):ActiveRecord
		{
			var primaryKey:String = schemaTranslation.getPrimaryKey(className);
		 ...
		 */
		public function update(id:String, updates:String, updateParams:Array = null):Boolean
		{
			var tableName:String = schemaTranslation.getTable(className);
			var primaryKey:String = schemaTranslation.getPrimaryKey(className);
		 ...
		 */
		public function deleteById(id:String):Boolean
		{
			var tableName:String = schemaTranslation.getTable(className);
			var primaryKey:String = schemaTranslation.getPrimaryKey(className);
		 ...
		 */
		public function incrementCounter(id:String, counter:String):void
		{
		 ...
		 */
		public function decrementCounter(id:String, counter:String):void
		{
			update(id, counter + " = " + counter + " - 1");
		}
